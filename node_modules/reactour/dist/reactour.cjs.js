...
var scrollSmooth__default = /*#__PURE__*/_interopDefaultLegacy(scrollSmooth);
...
var GlobalStyle = styled.createGlobalStyle(_templateObject$9 || (_templateObject$9 = _taggedTemplateLiteral(["\n  .focus-outline-hidden :focus {\n      outline: none;\n  }\n"])));

var _templateObject$8;
var SvgButton = styled__default['default'].button(_templateObject$8 || (_templateObject$8 = _taggedTemplateLiteral(["\n  display: block;\n  padding: 0;\n  border: 0;\n  background: none;\n  font-size: 0;\n  cursor: ", ";\n"])), function (props) {
  return props.disabled ? 'not-allowed' : 'pointer';
});

var _templateObject$7, _templateObject2;
var Label = styled__default['default'].span(_templateObject$7 || (_templateObject$7 = _taggedTemplateLiteral(["\n  font-size: 12px;\n  line-height: 1;\n"])));
...
var Arrow$1 = styled__default['default'](Arrow)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  color: ", ";\n\n  ", ";\n  ", ";\n\n  &:hover {\n    color: ", ";\n  }\n"])), function (props) {
...
var StyledClose = styled__default['default'](Close)(_templateObject$6 || (_templateObject$6 = _taggedTemplateLiteral(["\n  position: absolute;\n  top: 22px;\n  right: 22px;\n  width: 9px;\n  height: 9px;\n  color: #5e5e5e;\n  &:hover {\n    color: #000;\n  }\n"])));
...
var Guide = styled__default['default'].div(_templateObject$5 || (_templateObject$5 = _taggedTemplateLiteral(["\n  --reactour-accent: ", ";\n  ", "\n  position: fixed;\n  transition: transform 0.3s;\n  top: 0;\n  left: 0;\n  z-index: 1000000;\n\n  transform: ", ";\n"])), function (props) {
...
var Badge = styled__default['default'].span(_templateObject$4 || (_templateObject$4 = _taggedTemplateLiteral(["\n  position: absolute;\n  font-family: monospace;\n  background: var(--reactour-accent);\n  background: ", ";\n  height: 1.875em;\n  line-height: 2;\n  padding-left: 0.8125em;\n  padding-right: 0.8125em;\n  font-size: 1em;\n  border-radius: 1.625em;\n  color: white;\n  text-align: center;\n  box-shadow: 0 0.25em 0.5em rgba(0, 0, 0, 0.3);\n  top: -0.8125em;\n  left: -0.8125em;\n"])), function (props) {
  return props.accentColor;
});

var _templateObject$3;
var Controls = styled__default['default'].div(_templateObject$3 || (_templateObject$3 = _taggedTemplateLiteral(["\n  display: flex;\n  margin-top: 24px;\n  align-items: center;\n  justify-content: center;\n"])));

var _templateObject$2;
var Navigation = styled__default['default'].nav(_templateObject$2 || (_templateObject$2 = _taggedTemplateLiteral(["\n  counter-reset: dot;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  flex-wrap: wrap;\n"])));

var _templateObject$1;
var Dot = styled__default['default'].button(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral(["\n  counter-increment: dot;\n  width: 8px;\n  height: 8px;\n  border: ", ";\n\n  border-radius: 100%;\n  padding: 0;\n  display: block;\n  margin: 4px;\n  transition: opacity 0.3s, transform 0.3s;\n  cursor: ", ";\n  transform: scale(", ");\n\n  color: ", ";\n  background: ", ";\n\n  color: ", ";\n  background: ", ";\n\n  &:before {\n    content: counter(dot);\n    position: absolute;\n    bottom: calc(100% + 0.25em);\n    left: 50%;\n    opacity: 0;\n    transform: translate(-50%, 1em);\n    transition: 0.3s;\n    display: ", ";\n  }\n\n  &:hover {\n    background-color: currentColor;\n\n    &:before {\n      opacity: 0.5;\n      transform: translate(-50%, -2px);\n    }\n  }\n"])), function (props) {
...
SvgMask.propTypes = {
  windowWidth: PropTypes__default['default'].number.isRequired,
  windowHeight: PropTypes__default['default'].number.isRequired,
  targetWidth: PropTypes__default['default'].number.isRequired,
  targetHeight: PropTypes__default['default'].number.isRequired,
  targetTop: PropTypes__default['default'].number.isRequired,
  targetLeft: PropTypes__default['default'].number.isRequired,
  padding: PropTypes__default['default'].number.isRequired,
  rounded: PropTypes__default['default'].number.isRequired,
  roundedStep: PropTypes__default['default'].bool,
  disableInteraction: PropTypes__default['default'].bool.isRequired,
  disableInteractionClassName: PropTypes__default['default'].string.isRequired,
  highlightedBorder: PropTypes__default['default'].shape({
...
var propTypes = {
  disableFocusLock: PropTypes__default['default'].bool,
  badgeContent: PropTypes__default['default'].func,
  highlightedMaskClassName: PropTypes__default['default'].string,
  children: PropTypes__default['default'].oneOfType([PropTypes__default['default'].node, PropTypes__default['default'].element]),
  className: PropTypes__default['default'].string,
  closeButtonAriaLabel: PropTypes__default['default'].string,
  closeWithMask: PropTypes__default['default'].bool,
  inViewThreshold: PropTypes__default['default'].number,
  isOpen: PropTypes__default['default'].bool.isRequired,
  lastStepNextButton: PropTypes__default['default'].node,
  maskClassName: PropTypes__default['default'].string,
  maskSpace: PropTypes__default['default'].number,
  nextButton: PropTypes__default['default'].node,
  onAfterOpen: PropTypes__default['default'].func,
  onBeforeClose: PropTypes__default['default'].func,
  onRequestClose: PropTypes__default['default'].func,
  prevButton: PropTypes__default['default'].node,
  scrollDuration: PropTypes__default['default'].number,
  ...
  showNavigationNumber: PropTypes__default['default'].bool,
  showNumber: PropTypes__default['default'].bool,
  startAt: PropTypes__default['default'].number,
  goToStep: PropTypes__default['default'].number,
  getCurrentStep: PropTypes__default['default'].func,
  ...
  steps: PropTypes__default['default'].arrayOf(PropTypes__default['default'].shape({
    ...
    content: PropTypes__default['default'].oneOfType([PropTypes__default['default'].node, PropTypes__default['default'].element, PropTypes__default['default'].func]).isRequired,
    position: PropTypes__default['default'].oneOfType([PropTypes__default['default'].arrayOf(PropTypes__default['default'].number), PropTypes__default['default'].oneOf(['top', 'right', 'bottom', 'left', 'center'])]),
    action: PropTypes__default['default'].func,
    style: PropTypes__default['default'].object,
    stepInteraction: PropTypes__default['default'].bool,
    navDotAriaLabel: PropTypes__default['default'].string,
    roundedStep: PropTypes__default['default'].bool
  })),
  update: PropTypes__default['default'].string,
  updateDelay: PropTypes__default['default'].number,
  disableInteraction: PropTypes__default['default'].bool,
  disableDotsNavigation: PropTypes__default['default'].bool,
  disableKeyboardNavigation: PropTypes__default['default'].oneOfType([PropTypes__default['default'].arrayOf(PropTypes__default['default'].oneOf(['esc', 'right', 'left'])), PropTypes__default['default'].bool]),
  rounded: PropTypes__default['default'].number,
  ...
  function Tour() {
    ...
    _defineProperty(_assertThisInitialized(_this), "calculateNode", function (node, step, cb) {
      ...
      if (!inView(_objectSpread2(_objectSpread2({}, attrs), {}, {
        ...
        var parentScroll = Scrollparent__default['default'](node);
        var offset = scrollOffset ? scrollOffset : attrs.height > h ? -25 : -(h / 2) + attrs.height / 2;
        scrollSmooth__default['default'].to(node, {
    ...
    _this.debouncedShowStep = debounce__default['default'](_this.showStep, 70);
    return _this;
  }
  ...
  _createClass(Tour, [{
    ...
    value: function render() {
      ...
      if (isOpen) {
        return /*#__PURE__*/React__default['default'].createElement(Portal, null, /*#__PURE__*/React__default['default'].createElement(GlobalStyle, null), /*#__PURE__*/React__default['default'].createElement(ReactourResizeObserver, {
        ...
        }), /*#__PURE__*/React__default['default'].createElement(FocusLock__default['default'], {
          ...
          rounded: rounded,
          className: cn__default['default'](CN.helper.base, className, _defineProperty({}, CN.helper.isOpen, isOpen)),
          ...
          return /*#__PURE__*/React__default['default'].createElement(Dot, {
            ...
            "data-tour-elem": "dot",
            className: cn__default['default'](CN.dot.base, _defineProperty({}, CN.dot.active, current === i)),
